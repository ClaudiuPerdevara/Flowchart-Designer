...
1. Clone this repository using the command: [git clone https://github.com/ClaudiuPerdevara/uml-designer.git](https://github.com/ClaudiuPerdevara/Flowchart-Designer.git)
